  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center bg-slate-100 p-1 rounded-xl border border-slate-200 text-xs font-bold shrink-0">
          <button
            ...
            className={`px-3 py-1.5 rounded-lg transition-colors cursor-pointer ${
              activeTab === "SCHEDULES" ? "bg-[#1B365D] text-white font-bold shadow-xs" : "text-slate-600 hover:text-slate-900 hover:bg-slate-200/60"
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg transition-colors cursor-pointer ${
              activeTab === "CATALOG" ? "bg-[#1B365D] text-white font-bold shadow-xs" : "text-slate-600 hover:text-slate-900 hover:bg-slate-200/60"
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg transition-colors cursor-pointer ${
              activeTab === "INVARIANTS" ? "bg-[#1B365D] text-white font-bold shadow-xs" : "text-slate-600 hover:text-slate-900 hover:bg-slate-200/60"
            }`}
          >
      ...
      {activeTab === "SCHEDULES" && (
        <Reveal>
        <div className="space-y-6">
          <div className="bg-white p-6 space-y-4 border border-slate-200/90 rounded-xl shadow-xs">
            <div>
              ...
              <table className="min-w-full divide-y divide-slate-200 text-xs">
                ...
                <tbody className="divide-y divide-slate-200 font-normal text-slate-700">
                  <tr className="hover:bg-slate-50 transition-colors">
                    <td className="px-4 py-3 font-mono font-bold text-slate-800">1</td>
                    <td className="px-4 py-3">A ≤ 50 cm²</td>
                    <td className="px-4 py-3 font-bold text-[#1B365D] font-mono">1.0 mm</td>
                    <td className="px-4 py-3 font-mono text-slate-700">1.5 mm</td>
                    <td className="px-4 py-3 text-slate-500">{language === "hi" ? "पंक्ति 1, तालिका-I" : "Row 1, Table-I"}</td>
                  </tr>
                  <tr className="hover:bg-slate-50 transition-colors">
                    <td className="px-4 py-3 font-mono font-bold text-slate-800">2</td>
                    <td className="px-4 py-3">50 cm² &lt; A ≤ 100 cm²</td>
                    <td className="px-4 py-3 font-bold text-[#1B365D] font-mono">1.5 mm</td>
                    <td className="px-4 py-3 font-mono text-slate-700">3.0 mm</td>
                    <td className="px-4 py-3 text-slate-500">{language === "hi" ? "पंक्ति 2, तालिका-I" : "Row 2, Table-I"}</td>
                  </tr>
                  <tr className="hover:bg-slate-50 transition-colors">
                    <td className="px-4 py-3 font-mono font-bold text-slate-800">3</td>
                    <td className="px-4 py-3">100 cm² &lt; A ≤ 500 cm²</td>
                    <td className="px-4 py-3 font-bold text-[#1B365D] font-mono">2.5 mm</td>
                    <td className="px-4 py-3 font-mono text-slate-700">4.0 mm</td>
                    <td className="px-4 py-3 text-slate-500">{language === "hi" ? "पंक्ति 3, तालिका-I" : "Row 3, Table-I"}</td>
                  </tr>
                  <tr className="hover:bg-slate-50 transition-colors">
                    <td className="px-4 py-3 font-mono font-bold text-slate-800">4</td>
                    <td className="px-4 py-3">500 cm² &lt; A ≤ 2500 cm²</td>
                    <td className="px-4 py-3 font-bold text-[#1B365D] font-mono">4.0 mm</td>
                    <td className="px-4 py-3 font-mono text-slate-700">6.0 mm</td>
                    <td className="px-4 py-3 text-slate-500">{language === "hi" ? "पंक्ति 4, तालिका-I" : "Row 4, Table-I"}</td>
                  </tr>
                  <tr className="bg-amber-50/80 hover:bg-amber-100/60 border-y border-amber-300 transition-colors">
                    ...
                    <td className="px-4 py-3 font-mono text-slate-800 font-bold">6.0 mm</td>
                    <td className="px-4 py-3 font-bold text-amber-900">
                      {language === "hi" ? "संशोधन 2022 (सा.का.नि. 629(अ))" : "Amended 2022 (G.S.R. 629(E))"}
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="p-3.5 bg-amber-50 border border-amber-300 rounded-xl text-xs text-amber-950 space-y-1">
              <span className="font-bold uppercase tracking-wider text-[10px] text-amber-900 block">
                {language === "hi" ? "सांविधिक सीमांत सहिष्णुता सूचना:" : "Statutory Marginal Tolerance Notice:"}
              </span>
              <p className="text-[11px] leading-relaxed text-amber-900">
                {language === "hi"
                  ? "निर्णय ADL-01 के अंतर्गत, पंक्ति 5 (A > 2500 सेमी²) को ऐतिहासिक 8.0 मिमी से घटाकर अनिवार्य 6.0 मिमी कर दिया गया है। 8.0 मिमी का दावा करने वाली कोई भी डिजिटल प्रणाली सांविधिक रूप से अमान्य झूठी चेतावनी उत्पन्न करती है।"
      ...
      {activeTab === "CATALOG" && (
        <div className="space-y-3">
          {RULE_CATALOG.map((r) => {
            ...
            return (
              <div key={r.code} className="bg-white overflow-hidden border border-slate-200/90 rounded-xl shadow-xs">
                <button
                  type="button"
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="p-2 rounded-lg bg-blue-50 text-[#1B365D] shrink-0 border border-blue-200">
                      <GitBranch size={16} />
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="font-mono font-bold text-xs text-[#1B365D] bg-blue-50 px-2 py-0.5 rounded border border-blue-200">{r.code}</span>
                ...
                {isOpen && (
                  <div className="p-4 pt-3 border-t border-slate-200 bg-slate-50/70 space-y-3 text-xs">
                    <div>
      ...
      {activeTab === "INVARIANTS" && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-white p-5 space-y-3 border border-slate-200/90 rounded-xl shadow-xs">
            <div className="flex items-center gap-2 text-[#1B365D] font-bold text-sm">
              <ShieldCheck size={18} />
              <span>
                {language === "hi"
